...
func _physics_process(delta: float) -> void:
	...
	if Input.is_action_pressed("throttle_down"):
		...
		$Thrusters/Main/Left.get_active_material(0).set_shader_parameter("intensity", throttle / MAX_THROTTLE)
		$Thrusters/Main/Right.get_active_material(0).set_shader_parameter("intensity", throttle / MAX_THROTTLE)
